...
public enum ErrorCode implements ResponseCode {
    ...
    GAME_NOT_COMPLETED(HttpStatus.CONFLICT, "GAME_NOT_COMPLETED", "게임을 완료한 후 추천 상품을 조회할 수 있습니다."),
    CASE_SELECTION_NOT_ALLOWED(HttpStatus.CONFLICT, "CASE_SELECTION_NOT_ALLOWED", "FUNCTION 성공 후에만 SIGNATURE 사건을 진행할 수 있습니다."),
    FINAL_DEDUCTION_ALREADY_COMPLETED(HttpStatus.CONFLICT, "FINAL_DEDUCTION_ALREADY_COMPLETED", "종료된 사건은 다시 최종 추리할 수 없습니다."),
    CONVERSATIONS_NOT_COMPLETED(HttpStatus.CONFLICT, "CONVERSATIONS_NOT_COMPLETED", "현재 사건의 두 용의자와 대화를 모두 완료해야 합니다."),
